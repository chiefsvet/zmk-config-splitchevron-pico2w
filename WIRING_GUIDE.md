# HUZZAH32 Custom Keyboard — Wiring Guide & Flashing Instructions

## Overview

| Attribute | Value |
|-----------|-------|
| MCU | Adafruit HUZZAH32 ESP32 Feather |
| Matrix | 5 rows × 15 columns (physical keys at specified positions only) |
| Display | MakerFocus 1.3" SH1106 I²C OLED 128×64 |
| Encoder | EC11 rotary encoder with integrated push button |
